...
class Main
{
     ...
     * @return \app\twig\model\MenuList Indique la liste des menus de l'en-tête.
     */
    public function loadHeaderMenuList(): \app\twig\model\MenuList
    {
        $menuList = new \app\twig\model\MenuList();
     ...
     * Permet de retourner le répertoire des templates.
     * @return string Indique le répertoire des templates.
     */
    ...
    {
        return 'html/main.html.twig';
    }

    /**
     * Retourne le controleur de template twig de la page principale.
     * Permet de retourner le controleur de template twig de la page principale.
     * @return \app\twig\template\controller\Main Indique le controleur de template twig de la page principale.
     */
    public function getMainTemplateController(): \app\twig\template\controller\Main
    {
        $mainTemplateController = new \app\twig\template\controller\Main($this->getTemplateDir());
        return $mainTemplateController;
    }

    public function getPageTemplateController(): \app\twig\template\page\Page
    {
        $templateFactory = \app\twig\factory\Template::Instance();
        return $templateFactory->getTemplate($this->getPageId());
    }
}
