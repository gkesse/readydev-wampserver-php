...
class Main
{
     ...
     * @var \app\model\MenuList
     */
    private \app\model\MenuList $headerMenuList;
    /**
     * Stocke le menu courant.
     * @var \app\model\Menu
     */
    private \app\model\Menu $headerMenuCurrent;
    ...
    public function __construct()
    {
        ...
        $this->pageView = $controller->getPageView();
     ...
     * @param \app\model\Menu $p_in_current_menu Indique le menu courant.
     * @param string $p_out_text Indique le texte de sortie.
     * @return void
     */
     ...
     * @return void
     */
    private function runHeaderSubMenu(int $p_in_parent_index, \app\model\Menu $p_in_current_menu, string &$p_out_text): void
    {
        $menuListI = $this->headerMenuList->getMenuListByParentIndex($p_in_parent_index);
        $menuK = new \app\model\Menu();
    ...
    {
        $pageFactory = \app\factory\Page::Instance();
