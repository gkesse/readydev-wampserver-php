...
class Main
{
     ...
     * @return \app\model\MenuList Indique la liste des menus de l'en-tête.
     */
    public function loadHeaderMenuList(): \app\model\MenuList
    {
        $menuList = new \app\model\MenuList();
